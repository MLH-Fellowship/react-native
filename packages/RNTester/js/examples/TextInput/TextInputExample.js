...
exports.description = 'A foundational component for inputting text into the app via a keyboard.';
exports.examples = ([
    {
          ...
          return (
            <View>
               <WithLabel label="Enter Title">
                <TextInput autoCapitalize="words" style={styles.default} placeholder="Capitalise Words"/>
              </WithLabel>
              <WithLabel label="Enter Description">
                <TextInput autoCapitalize="sentences" style={styles.default} placeholder="Capitalise Sentences"/>
              </WithLabel>
              <WithLabel label="Enter Author Name">
                <TextInput autoCapitalize="characters" style={styles.default} placeholder="Capitalise Characters"/>
              </WithLabel>
            </View>
          );
        },
        ...
        render: function(): React.Node {
          return (
              <WithLabel label="Registered Email:">
                <TextInput defaultValue="tester@reactnative.dev"
                  editable={false}
                 style={styles.default} />
              </WithLabel>
          );
      ...
      },
      {
        ...
        render: () => { 
          return( 
            <WithLabel label="Password">
              <TextInput style={styles.default} secureTextEntry={true} textContentType="newPassword" 
      ...
      {
        title: "TextInput with dataDetectorTypes='all' with multiline={true} and editable={false}",
        platform: "iOS",
        description: "Possible values for dataDetectorTypes are: 'phoneNumber', 'link' , 'address', 'calendarEvent', 'none', 'all'",
        render: () => { 
